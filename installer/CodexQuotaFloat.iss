...
OutputDir=..\dist
OutputBaseFilename=CodexQuotaFloat-Setup-1.2.1-win-x64
Compression=lzma2
...
[Files]
Source: "..\release\CodexQuotaFloat-1.2.1-win-x64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
